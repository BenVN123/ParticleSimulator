...
main.o: main.c main.h platform.h particles.h segments.h utils.h
	$(CC) $(CFLAGS) $(LDFLAGS) -c $< -o $@

platform.o: platform.c platform.h particles.h
	$(CC) $(CFLAGS) $(LDFLAGS) -c $< -o $@

particles.o: particles.c particles.h segments.h utils.h
	$(CC) $(CFLAGS) $(LDFLAGS) -c $< -o $@

segments.o: segments.c segments.h particles.h utils.h
